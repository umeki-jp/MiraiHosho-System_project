# flaskapp/utils/customer_fields.py
...
field_names = [
    ...
    "individual_workplace", "individual_workplace_postalcode",
    "individual_workplace_prefecture", "individual_workplace_city",
    "individual_workplace_address", "individual_workplace_tel",
    "individual_occupation", "individual_industry",
    "corporate_registrationnumber", "corporate_representative",
    "corporate_postalcode", "corporate_prefecture", "corporate_city",
    "corporate_address", "corporate_foundationdate", "corporate_capital",
